...
public interface ProgrammeRepository extends CrudRepository<Programme, UUID> {
    ...
    String FULLTEXT_SEARCH_QUERY = "SELECT ProgrammeUuid, SeasonUuid, SeriesUuid, VQ_EpisodeNumber, VQ_Title, VQ_TitleLongSynopsis FROM booksmart.Programme WHERE MATCH (VQ_Title, VQ_EpisodeName, DQ_SeriesName, " +
